...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.appc.mymodule.js')
	...
	f = os.path.join(cwd,'Classes','ComAppcMymoduleModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.appc.mymodule.js']
